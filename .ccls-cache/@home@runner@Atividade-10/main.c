...
int main(void) {
  ...
  lista_txt(); // lista os registros do arquivo txt
  putchar('\n');
  lista_txtSRT(); // lista os registros do arquivo txt sorted
  putchar('\n');

  // le_txt(77); // leitura de uma entrada do arquivo txt
  // putchar('\n');
  // le_txtSRT(77); // leitura de uma entrada do arquivo txt sorted
  // putchar('\n');

  // adiciona_txt("Rosinha", "Amarela", lista_ids); // adiciona uma entrada no arquivo txt
  // putchar('\n');
  // adiciona_txtSRT("Rosinha", "Amarela", lista_ids); // adiciona uma entrada no arquivo txt sorted
  // putchar('\n');

  // atualiza_txt(77, "Rosa", "Colorida", florArray); // atualiza uma entrada no arquivo txt
  // putchar('\n');
  // atualiza_txtSRT(77, "Rosa", "Colorida"); // atualiza uma entrada no arquivo txt sorted
  // atualiza_txtSRT(900, "Rosa", "Colorida"); // tentativa de atualizar uma entrada inexistente no arquivo txt sorted
  // putchar('\n');

  // remove_txt(5, florArray); // remove uma entrada no arquivo txt
  // putchar('\n');
  // remove_txtSRT(5); // remove uma entrada no arquivo txt sorted
  // remove_txtSRT(1000); // tentativa de remover uma entrada inexistente no arquivo txt sorted
  // putchar('\n');
